...
\bsc{Gnu}/Linux comme \textcolor{Cdl}{Debian} ou 
...
\begin{minipage}{0.3\textwidth}
\begin{center}
\includegraphics[scale=0.8]{Open-source-hardware-logo.png}\\
...
licence libre des objets 3D. Certaines imprimantes sont elles-mêmes 
