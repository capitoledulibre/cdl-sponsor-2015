...
{\tiny
 ...
 \textbf{Photo hall N7} : Clément \bsc{Hubin-Andrieu} \textcolor{Cdl}{$\bullet$}
 \textbf{Photo clavier braille} : Jean \bsc{Zaorski} \textcolor{Cdl}{$\bullet$}
 \textbf{Photo imprimante 3D} : Jean \bsc{Zaorski} \textcolor{Cdl}{$\bullet$}
